...
public class App
{
    ...
    private App() throws Exception
    {
        ...
        addRemoteVideoControlEvent    = new SingleAction<StreamLinkInitArgs>() { public void invoke(StreamLinkInitArgs e) { addRemoteVideoControl(e);    } };
        removeRemoteVideoControlEvent = new SingleAction<StreamLinkDownArgs>() { public void invoke(StreamLinkDownArgs e) { removeRemoteVideoControl(e); } };
